...
public enum BroadcastEnum {
    ...
    ,BLUETOOTH_CONNECT_SUCCESS("BLUETOOTH_CONNECT_SUCCESS","连接蓝牙成功")
    ,BLUETOOTH_CONNECT_FAIL("BLUETOOTH_CONNECT_FAIL","连接蓝牙失败")
    ,BLUETOOTH_UN_CONNECT("BLUETOOTH_UN_CONNECT","断开蓝牙连接")
    ,BLUETOOTH_SEND_DATA("BLUETOOTH_SEND_DATA","发送数据")
    ;
