...
public class PrintOrderDataMaker implements PrintDataMaker {
    ...
    public PrintOrderDataMaker(int width, int height) {
        this.width = width;
        this.height = height;
    }
...
//             data.addAll(image1);
            ...
            printer.setAlignCenter();
            printer.print(new SimpleDateFormat("yyyy/MM/dd HH:mm", Locale.getDefault()).format(new Date(System.currentTimeMillis())));
            printer.printLineFeed();
            printer.printLine();
